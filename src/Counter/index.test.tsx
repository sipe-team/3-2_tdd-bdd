...
describe('Counter 컴포넌트 UI 테스트', () => {
    ...
    it('버튼 그룹이 순서대로 [감소-증가-리셋-실행취소] 버튼을 포함해야 한다', () => {
        // 질문: 버튼 그룹 테스트 시 접근 방식에 대한 고민이 있습니다.
        // 1) 'button-group'이라는 data-testid를 추가하고 within을 사용하여 특정 그룹 내부 버튼을 테스트하는 방식.
        // 2) 현재처럼 role만 사용하여 전체 버튼을 테스트하는 방식.
        // 
        // 실무에서는 어떤 방식이 더 많이 사용되거나 유지보수 측면에서 유리한가요?
        // 또한, 특정 컴포넌트 구조나 상황에 따라 적합한 방식이 달라질 수 있는지 궁금합니다.
        // (참고: 질문에 대한 논의를 위해 setup을 사용한 리팩토링은 적용하지 않았습니다.)
